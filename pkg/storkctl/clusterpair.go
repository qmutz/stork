...
func newCreateClusterPairCommand(cmdFactory Factory, ioStreams genericclioptions.IOStreams) *cobra.Command {
	...
	createClusterPairCommand.Flags().StringVarP(&sIP, "srcip", "", "", "ip of storage node from source cluster")
	createClusterPairCommand.Flags().StringVarP(&sPort, "srcport", "", "9001", "port of storage node from source cluster")
	createClusterPairCommand.Flags().StringVarP(&sFile, "src-kube-file", "", "", "kube-config of source cluster")
	createClusterPairCommand.Flags().StringVarP(&dIP, "destip", "", "", "kube-config of destination cluster")
	createClusterPairCommand.Flags().StringVarP(&dPort, "destport", "", "9001", "port of storage node from destination cluster")
	createClusterPairCommand.Flags().StringVarP(&dFile, "dest-kube-file", "", "", "kube-config of destination cluster")
	createClusterPairCommand.Flags().StringVarP(&srcToken, "srctoken", "", "", "source cluster token for cluster pairing")
	createClusterPairCommand.Flags().StringVarP(&destToken, "desttoken", "", "", "destination cluster token for cluster pairing")
